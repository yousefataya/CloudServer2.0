...
import com.experts.core.biller.statemachine.api.rovo.awsxray.domain.entities.mongo.MongoBaseClazz;
...
public class BaseMongoService<E extends MongoBaseClazz> {
    ...
    public String persist(E entity) throws PersistenceRuntimeException {
    ...
    public String getId(final String uuid) {
        return getId(uuid, false);
    }

    public String getId(final String uuid, final boolean includeDisabled) {
        if ((uuid == null) || uuid.isEmpty()) {
            return null;
        }
