...
public class TaskVariables extends AbstractEntity {
    ...
    @SpaceIndex
    @SpacePersist
    public TasksBake getTasks() {
        return tasks_;
    }

    public void setTasks(TasksBake tasks) {
        this.tasks_ = tasks;
    }
    ...
    public TaskVariables(String varibleName , VaribleType type , String value , TasksBake tasks , int abc) {
    	this.tasks_ = tasks;
    	this.type = type;
    	this.value=value;
    	this.varibleName = varibleName;
    ...
    public static class Builder{
        ...
        @SpaceIndex
        @SpacePersist
        public Builder task(TasksBake task){
            this.task = task;
            return this;
        }
        ...
        public TasksBake getTask() {
            return task;
        }

        public void setTask(TasksBake task) {
            this.task = task;
        }
    ...
    public TasksBake getTasks_() {
        return tasks_;
    }

    public void setTasks_(TasksBake tasks_) {
        this.tasks_ = tasks_;
    }
}
