...
package org.mitre.mitre.discovery.web;
...
import org.mitre.mitre.oauth2.web.DeviceEndpoint;
import org.mitre.mitre.oauth2.web.IntrospectionEndpoint;
import org.mitre.mitre.oauth2.web.RevocationEndpoint;
import org.mitre.mitre.openid.connect.view.HttpCodeView;
import org.mitre.mitre.openid.connect.view.JsonEntityView;
import org.mitre.mitre.openid.connect.web.DynamicClientRegistrationEndpoint;
import org.mitre.mitre.openid.connect.web.EndSessionEndpoint;
import org.mitre.mitre.openid.connect.web.JWKSetPublishingEndpoint;
import org.mitre.mitre.openid.connect.web.UserInfoEndpoint;
...
public class DiscoveryEndpoint {
	...
	@Autowired
	private JWTEncryptionAndDecryptionService jwtEncryption;
	...
	public String providerConfiguration(Model model) {
		...
		m.put("userinfo_encryption_alg_values_supported", Collections2.transform(jwtEncryption.getAllEncryptionAlgsSupported(), toAlgorithmName));
		m.put("userinfo_encryption_enc_values_supported", Collections2.transform(jwtEncryption.getAllEncryptionEncsSupported(), toAlgorithmName));
		...
		m.put("id_token_encryption_alg_values_supported", Collections2.transform(jwtEncryption.getAllEncryptionAlgsSupported(), toAlgorithmName));
		m.put("id_token_encryption_enc_values_supported", Collections2.transform(jwtEncryption.getAllEncryptionEncsSupported(), toAlgorithmName));
		...
		m.put("request_object_encryption_alg_values_supported", Collections2.transform(jwtEncryption.getAllEncryptionAlgsSupported(), toAlgorithmName));
		m.put("request_object_encryption_enc_values_supported", Collections2.transform(jwtEncryption.getAllEncryptionEncsSupported(), toAlgorithmName));
