...
import org.mitre.mitre.oauth2.web.AuthenticationUtilities;
import org.mitre.mitre.openid.connect.exception.ValidationException;
import org.mitre.mitre.openid.connect.view.*;
...
public class ClientAPI {
	...
	@Autowired
	private AssertionValidator jwtAssertionValidator;
	...
	private ClientDetailsEntity validateSoftwareStatement(ClientDetailsEntity newClient) throws ValidationException {
		if (newClient.getSoftwareStatement() != null) {
			if (jwtAssertionValidator.isValid(newClient.getSoftwareStatement())) {
