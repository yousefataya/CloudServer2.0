...
public class DefaultApprovedSiteService implements ApprovedSiteService {
	 ...
	 * @param userId
	 * @return
	 * @see org.mitre.openid.connect.repository.ApprovedSiteRepository#getByUserId(String)
	 */
	@Override
	 ...
	 * @param clientId
	 * @return
	 * @see org.mitre.openid.connect.repository.ApprovedSiteRepository#getByClientId(String)
	 */
	@Override
