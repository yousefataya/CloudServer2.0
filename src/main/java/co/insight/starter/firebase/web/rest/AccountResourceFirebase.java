...
public class AccountResourceFirebase {
    ...
    @Autowired
    private UserHrmsModule userHrmsModule;
    ...
    public ResponseEntity<?> registerAccount(@RequestBody UserDTO userDTO, HttpServletRequest request, HttpServletResponse response){
        ...
        if (user != null) {
            ...
            user = userHrmsModule.createUserInformation(userDTO.getLogin(), userDTO.getPassword(), userDTO.getFirstName(),userDTO.getLastName(), userDTO.getEmail().toLowerCase(), userDTO.getLangKey());
    ...
    public ResponseEntity<String> activateAccount(@RequestParam(value = "key") String key) {
        User user = userHrmsModule.activateRegistration(key);
        if (user == null) {
    ...
    public ResponseEntity<UserDTO> getAccount() {
        User user = userHrmsModule.getUserWithAuthorities();
        if (user == null) {
            return new ResponseEntity<>(HttpStatus.INTERNAL_SERVER_ERROR);
        }
    ...
    public void saveAccount(@RequestBody UserDTO userDTO) {
        userHrmsModule.updateUserInformation(userDTO.getFirstName(), userDTO.getLastName(), userDTO.getEmail());
    }
    ...
    public ResponseEntity<?> changePassword(@RequestBody String password) {
        ...
        userHrmsModule.changePassword(password);
